...
local size, path= ngx.var.size, ngx.var.path
...
--local function calculate_signature(str)
 -- return ngx.encode_base64(ngx.hmac_sha1(secret, str)):sub(1,12)
--end
...
ngx.say("images/".. calculate_signature(size .."/"..path) .. "/" .. size .."/"..path)
