...
public class DataEncryptUtil {
    ...
    public static void main(String[] args) {
        String inputStr = "80x80/leafo.jpg";
        System.err.println("原文:\n" + inputStr);

        String code;
        try {
            byte[] key = DataEncryptUtil.encryptHMAC(inputStr.getBytes(),"hello_world");
            System.err.println(DataEncryptUtil.encryptBASE64(key));
//            code = DataEncryptUtil.encryptBASE64(inputStr.getBytes());
...
//            DataEncryptUtil.encryptHMAC( "hello_world".getBytes(), key);
//            BigInteger mac = new
